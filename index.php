		...
		<div class="b-block b-920">
			...
			<div class="clearfix">
				<div class="left left-block">
					...
					<p>
						Совершенная немецкая электроника обрабатывает 8 млн операций в секунду<br>
						<b>Сохраняется дилерская гарантия</b><br>
						Чип-блоки сертифицированы<br>как дополнительно оборудование<br>для <span><?=$car_rod?></span>
					</p>
				...
				<div class="right right-block">
					...
					<p>
						Более 5000 программ разработаны<br>и протестированы индивидуально<br>под каждую модель автомобиля<br>
